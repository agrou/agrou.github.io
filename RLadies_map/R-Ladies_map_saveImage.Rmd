...
library(webshot)
library(mapview)
#mapshot(RLmap, file = "~/RLmap.png")

# save html to png
saveWidget(RLmap, "temp.html", selfcontained = FALSE)
webshot("temp.html", file = "RLmap.png", vheight = 375, cliprect = NULL)
```
